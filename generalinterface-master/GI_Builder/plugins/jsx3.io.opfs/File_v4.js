...
(function() {
    ...
    // This intercepts and routes all file:/// XMLHttpRequests (like config.xml loading)
    // to our OPFS virtual filesystem, avoiding browser CORS/file-access security blocks.
    if (window.jsx3 && jsx3.net && jsx3.net.Request && jsx3.io && jsx3.io.FileRequest) {
    ...
    // to load local files via FileRequest + eval instead of creating <script src="file://"> tags
    // which are strictly blocked in modern browsers.
